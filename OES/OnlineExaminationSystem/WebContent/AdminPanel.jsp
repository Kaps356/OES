	...
	<center>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-6"><center><input onclick="location.href='resultstore.jsp'"type="button" value="Show Progress" class="btn btn-outline-primary btn-lg btn-block"></center></div>
			</div>  
		</div>
