...
<%@page import="oes.dao.StudentsDao"%>
	...
	<center>
		<pre>
			<table class="table table-hover">
				<tr>
					<th colspan="2">
					<center><h4><font color="red">Instructions to Students</font></h4></center>
				</th>
			</tr>
			<tr>
				<tr>
		...
		<pre>
			<button type="button" class="btn btn-outline-primary btn-lg" onclick="location.href='oes.controller.LogoutStudent'">Logout</button>   
